...
public class Home extends JFrame{
    ...
    private void initGui(){
        ...
        //主页图片
        image = new ImageIcon("src/Gui/library-1400312_1920.jpg");
        //设置menubar
        setJMenuBar(JMB);

        toolBar = new JToolBar();
        //创建图表对象
        ImageIcon imageSmanage = new ImageIcon("src/Gui/14.png");
        ImageIcon imageCmanage = new ImageIcon("src/Gui/12.png");
        ImageIcon imageFinace = new ImageIcon("src/Gui/8.png");
        ImageIcon imageSign = new ImageIcon("src/Gui/7.png");
        //创建工具栏
